...
Finalmente, necessitamos una funcion que inhabilite el interrupt. Para ese tenemos el DetachInterrupt, que solo se activara quando haya pasado 1 minuto despues de haber arrancado el programa.
...
Con la función timerAlarmWrite declaramos la configuracion de la interrupcion. Es decir,  cada quanto queremos que se interrupa el proceso loop i si lo queremos hacer de forma periódica. Finalmente timerAlarmEnable() habilita la Interrupcion.
